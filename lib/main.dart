  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      textAlign: TextAlign.center,),
        ...
        SizedBox(height: 20),
            TextButton(
              onPressed: () {print('You Clicked OutLine Button');}, 
              child: Text("Click Me",
        ...
        SizedBox(height: 20),
            Center(
              child: Image.network("https://images.app.goo.gl/6wzRKuRwoHVjJriY7", 
                width: 100, height: 100,),),

                 
        SizedBox(height: 10),
            Center(child: Icon
                   (Icons.computer, size: 200, 
                    color: Colors.orange),),
        ...
        Row(children: [
          ...
          Text("Male"),
            Radio(value: "Female", groupValue: selectGender, 
                  onChanged: (value) {setState(() 
                  {selectGender = value.toString();});},),
            Text("Female"),
          ],),
        ...
        Column(
          ...
          children: [Text("Volume: ${sliderValue.toInt()}"),
